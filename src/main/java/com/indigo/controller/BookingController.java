...
import com.indigo.service.EmailService;
import com.indigo.service.PDFService;
import com.indigo.service.SmsService;
...
private EmailService emailService;
    ...
    public ResponseEntity<?> createBooking(@RequestBody Booking booking,
        ...
        boolean b = pdfService.generatePDF("C://oct//" + "booking-confirmation-id" + createdBooking.getId() + ".pdf", dto);
        if (b) {

        MultipartFile file=BookingController.convert("C://oct//" + "booking-confirmation-id" +createdBooking.getId() + ".pdf");
            String uploadedFileUrl = bucketService.uploadFile(file, "myindigo1");
//System.out.println(uploadedFileUrl);
            smsService.sendSms("+919301615909","TEST");
            emailService.sendEmail("saranshasati1312@gmail.com","TEST","body");
        } else {
            return new ResponseEntity<>("Something Went wrong", HttpStatus.INTERNAL_SERVER_ERROR);
// Upload Your fle into bucket
        }
